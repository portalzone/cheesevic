...
const classes = computed(() => {
    return props.active
        ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-indigo-400 text-start text-base font-medium text-white bg-slate-700 focus:outline-none focus:text-slate-300 focus:bg-slate-700 focus:border-indigo-700 transition duration-150 ease-in-out'
